...
describe('MeatPicker', () => {
  it('bez partii w zleceniu wszystkie kafelki są klikalne', () => {
    render(<MeatPicker meat={meat} orderLots={[]} targetKg={200} onConfirm={vi.fn()} onBack={vi.fn()} />)
  ...
  it('z partią biura reszta kafelków jest szara i nieklikalna', () => {
    render(<MeatPicker meat={meat} orderLots={[{ meatLotNo: '511' }]} targetKg={200} onConfirm={vi.fn()} onBack={vi.fn()} />)
    expect(screen.getByRole('button', { name: /PAL\/17\/09\/26\/1/ })).toBeEnabled()
  ...
  it('filet z mostka wskazany przez biuro JEST do wzięcia, choć nie ma palety', () => {
    render(<MeatPicker meat={meat} orderLots={[{ meatLotNo: '524' }]} targetKg={600} onConfirm={vi.fn()} onBack={vi.fn()} />)
  ...
  it('pasek nad siatką wypisuje partie wskazane przez biuro', () => {
    render(<MeatPicker meat={meat} orderLots={[{ meatLotNo: '511' }, { meatLotNo: '513' }]}
      targetKg={400} onConfirm={vi.fn()} onBack={vi.fn()} />)
  ...
  it('kliknięcie kafelka palety dokłada jego kilogramy do wsadu', () => {
    ...
    render(<MeatPicker meat={meat} orderLots={[]} targetKg={200} onConfirm={onConfirm} onBack={vi.fn()} />)
  ...
  it('kafelek szary nie reaguje na dotyk', () => {
    const onConfirm = vi.fn()
    render(<MeatPicker meat={meat} orderLots={[{ meatLotNo: '511' }]} targetKg={200} onConfirm={onConfirm} onBack={vi.fn()} />)
  ...
  it('paleta mieszana z partią spoza planu jest nieklikalna', () => {
    ...
    render(<MeatPicker meat={mieszane} orderLots={[{ meatLotNo: '511' }]} targetKg={200}
