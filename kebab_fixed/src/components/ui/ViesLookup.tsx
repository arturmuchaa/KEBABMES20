 ...
 * Używa oficjalnego REST API Komisji Europejskiej (przez backend proxy).
 */
...
// Wykrycie trybu Tauri — musi używać absolutnego URL do VPS
...
export function ViesLookup({ onFound }: Props) {
  ...
  async function handleSearch() {
    ...
    try {
      ...
      // Sprawdź czy odpowiedź to JSON (nie HTML strona błędu)
      ...
      {result && (
        <div className="border-2 border-green-300 bg-green-50 rounded-xl p-3 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2 text-[12px]">
            <div>
              <div className="text-[10px] font-bold text-slate-400 uppercase">Numer VAT</div>
