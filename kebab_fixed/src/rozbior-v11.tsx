/**
 * rozbior-v11.tsx — WARIANT „wzmocnione prowadzenie" (osobny build do porównania).
 *
 * To ten sam ekran co v10 (DeboningHmiV10Page), ale z propem `guided`: u góry
 * kolumny wpisu pojawia się wielki baner „KROK n/5 — co teraz zrobić", żeby
 * operator nigdy nie zgubił się w gęstym ekranie. Dane pozostają widoczne.
 * Cel: wgrać obok produkcji v10 na maszynę testową i porównać na żywo.
 * Osobny identyfikator/instalator (pl.kebabmes.rozbior-v11), BEZ auto-update —
 * to build eksperymentalny, dostarczany jako GitHub Release do ręcznej instalacji.
 *
...
declare const __ROZBIOR_V11_VERSION__: string
const BUILD_LABEL = `HMI v11 prowadzony · ${__ROZBIOR_V11_VERSION__}`
...
function KioskLoginScreen() {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center gap-8"
      ...
      <ServiceMenuModal open={serviceModal} onClose={() => setServiceModal(false)} buildLabel={BUILD_LABEL} />
    </div>
  )
}
...
function KioskGate() {
  ...
  return <DeboningHmiV10Page allowOperatorSwitch guided buildLabel={BUILD_LABEL} />
}
