...
CREATE TABLE IF NOT EXISTS byproduct_batches (
    id TEXT PRIMARY KEY,
    type TEXT NOT NULL,
    source_deboning_entry_id TEXT REFERENCES deboning_entries(id),
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "reset":
        ...
        try:
            ...
            migrations = [
                ...
                """),
                ("byproduct_batches", "create_table", """
                    CREATE TABLE IF NOT EXISTS byproduct_batches (
                        id TEXT PRIMARY KEY,
                        type TEXT NOT NULL,
                        source_deboning_entry_id TEXT,
                        weight NUMERIC(10,3) DEFAULT 0,
                        timestamp TIMESTAMPTZ DEFAULT NOW(),
                        notes TEXT,
                        created_at TIMESTAMPTZ DEFAULT NOW()
                ...
                """),
                ("deboning_entries", "kg_backs_fix", "ALTER TABLE deboning_entries ADD COLUMN IF NOT EXISTS kg_backs NUMERIC(10,3) DEFAULT 0"),
                ("deboning_entries", "kg_bones_fix", "ALTER TABLE deboning_entries ADD COLUMN IF NOT EXISTS kg_bones NUMERIC(10,3) DEFAULT 0"),
            ]
